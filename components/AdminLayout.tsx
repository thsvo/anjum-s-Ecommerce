  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Admin dashboard for managing the ecommerce store" />
      </Head>
        ...
        <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gray-900 text-white transition-all duration-300`}>
          <div className="p-4">
            <div className="flex items-center space-x-2">
              ...
              {sidebarOpen && <span className="text-xl font-bold">Anjum's Admin</span>}
            </div>
          </div>
            ...
            {menuItems.map((item) => (
              <Link
                ...
                className={`flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors ${
                  router.pathname === item.href ? 'bg-gray-800 text-white border-r-4 border-orange-500' : ''
                }`}
              >
            ...
            <div className="flex items-center justify-between px-6 py-4">
              ...
              <div className="flex items-center space-x-4">
                <button className="relative text-gray-600 hover:text-gray-900">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5-5-5h5v-5a7 7 0 000-14h-5l5-5 5 5h-5v5a7 7 0 000 14z" />
                  </svg>
